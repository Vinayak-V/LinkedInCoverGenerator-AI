...
// Replaced lucide-react imports with inline SVGs to avoid loading/forwardRef errors in the preview environment.
...
const Layout = ({ size = 24, className = "" }) => (<svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>);
...
const THEMES = [
  ...
  },
  {
    ...
    watermark: 'rgba(240, 171, 252, 0.08)'
  },
  {
    ...
    watermark: 'rgba(52, 211, 153, 0.08)'
  },
  {
    ...
    watermark: 'rgba(192, 132, 252, 0.08)'
  }
];
...
// Helper to make API calls to Gemini with exponential backoff
...
export default function App() {
  ...
  useEffect(() => {
    drawCanvas();
  }, [name, title, subtitle, themeIndex, layout, codeSnippets]);
  ...
  const handleGenerateSubtitles = async () => {
    ...
    try {
      ...
      setApiError("Failed to generate AI slogans. Please try again later.");
    } finally {
  ...
  const handleGenerateSnippets = async () => {
    ...
    try {
      ...
      setApiError(`Magic Watermarks Error: ${error.message}`);
    } finally {
          ...
          <div className="p-4 md:p-8 flex justify-center bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-gray-50">
            ...
            */}
            <div className="relative w-full max-w-[1584px] shadow-2xl rounded-lg overflow-hidden border border-gray-800/20">
              ...
              {layout === 'left' && (
                <div className="absolute bottom-[-15%] left-[5%] w-[18%] pt-[18%] bg-gray-300 rounded-full border-4 border-white shadow-lg opacity-50 flex items-center justify-center pointer-events-none">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 bg-purple-100 hover:bg-purple-200 text-purple-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors disabled:opacity-50 border border-purple-200 shrink-0"
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">✨ Magic Watermarks</span>
                  </button>
                </div>
              </div>
